...
Plataforma full stack para gestao operacional de contratos SaaS, servicos digitais, relacionamentos, documentacao e repasses internos.
...
| --- | --- | --- | --- |
| Administrador | `demo.admin` | defina em `APP_SECURITY_ADMIN_PASSWORD` | Consulta, cria, edita, ativa/inativa e importa dados |
| Visualizador | `demo.viewer` | defina em `APP_SECURITY_VIEWER_PASSWORD` | Consulta paineis, detalhes, softwares e repasses |
...
```bash
export SPRING_DATASOURCE_URL=jdbc:postgresql://localhost:5432/atlas_portfolio
export SPRING_DATASOURCE_USERNAME=atlas_app
export SPRING_DATASOURCE_PASSWORD=defina-uma-senha-local

export APP_SECURITY_ADMIN_USERNAME=demo.admin
export APP_SECURITY_ADMIN_PASSWORD=defina-uma-senha-admin
export APP_SECURITY_VIEWER_USERNAME=demo.viewer
